...
namespace CirclesFundMe.Infrastructure.Migrations
{
    ...
    [Migration("20250813173029_Communications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CirclesFundMe.Domain.Entities.AdminPortal.Communication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex(new[] { "Title" }, "IX_Communication_Title");

                    b.ToTable("Communications", "CFM");
                });

            modelBuilder.Entity("CirclesFundMe.Domain.Entities.AdminPortal.CommunicationRecipient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex(new[] { "UserId" }, "IX_CommunicationRecipient_UserId");

                    b.ToTable("CommunicationRecipients", "CFM");
                });
            ...
            modelBuilder.Entity("CirclesFundMe.Domain.Entities.AdminPortal.CommunicationRecipient", b =>
                {
                    b.HasOne("CirclesFundMe.Domain.Entities.AdminPortal.Communication", "Communication")
                        .WithMany("Recipients")
